...
\item \label{ded:veeOut} \(\phi \lor \psi,\ \phi \to \theta,\ \psi \to \theta \proves \theta\)
  \begin{ND}[][][][\rwidth{ded:wedgeComm1}]
    ...
    \ndl{}{\(\neg\phi \to \neg\neg\theta\)}{\ref{5}，演绎\oldref{ded:dnInConseq}}\label{6}
    \ndl{}{\(\neg\theta \to \phi\)}{\ref{6}，演绎\oldref{ded:axiom3alt}}\label{7}
    \ndl{}{\((\neg\theta \to \phi) \to (\neg\theta \to \neg\phi) \to \theta\)}{\(\rm P_3\)}\label{8}
    \ndl{}{\(\neg\neg\phi \to \theta\)}{\ref{2}，演绎\oldref{ded:dnInAnte}}\label{9}
    \ndl{}{\(\neg\neg\phi \to \neg\neg\theta\)}{\ref{9}，演绎\oldref{ded:dnInConseq}}\label{10}
    \ndl{}{\(\neg\theta \to \neg\phi\)}{\ref{10}，演绎\oldref{ded:axiom3alt}}\label{11}
    \ndl{}{\((\neg\theta \to \neg\phi) \to \theta\)}{\ref{7}，\ref{8}，MP}\label{12}
    \ndl{}{\(\theta\)}{{\ref{11}，\ref{12}，MP}}
  \end{ND}
...
\item \label{ded:wAnte} \(\phi \to \theta,\ \psi \to \theta \proves \phi \lor \psi \to \theta\)
  \begin{ND}[][][][\rwidth{ded:wedgeComm1}]
    ...
    \ndl{}{\((\phi \to \theta) \to (\neg\psi \to \phi) \to (\neg\psi \to \theta)\)}{证明\oldref{thm:trans}，演绎\oldref{ded:comm}}\label{5}
    \ndl{}{\((\neg\phi \to \psi) \to (\neg\psi \to \phi)\)}{证明\oldref{thm:axiom3alt2}}\label{6}
    \ndl{}{\((\neg\psi \to \phi) \to (\neg\psi \to \theta)\)}{\ref{1}，\ref{5}，MP}\label{7}
    \ndl{}{\((\neg\phi \to \psi) \to (\neg\psi \to \theta)\)}{\ref{6}，\ref{7}，演绎\oldref{ded:trans}}\label{8}
    \ndl{}{\((\neg\psi \to \theta) \to (\neg\theta \to \psi)\)}{证明\oldref{thm:axiom3alt2}}\label{9}
    \ndl{}{\((\neg\phi \to \psi) \to (\neg\theta \to \psi)\)}{\ref{8}，\ref{9}，演绎\oldref{ded:trans}}\label{10}
    \ndl{}{\((\neg\theta \to \psi) \to \theta\)}{\ref{3}，\ref{4}，MP}\label{11}
    \ndl{}{\((\neg\phi \to \psi) \to \theta\)}{\ref{10}，\ref{11}，演绎\oldref{ded:trans}}\label{12}
    \ndl{}{\(\phi \lor \psi \to \theta\)}{\ref{12}，定义2.2.4}
  \end{ND}
\end{enumerate}
