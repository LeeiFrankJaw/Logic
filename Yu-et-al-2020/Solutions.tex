...
\item[定理 2.4.21]
  ...
  \item
    ...
    \item \(\Set{\phi, \psi} \proves \phi \land \psi\)\hfill（合取引入）
      \begin{proof}
        \leavevmode
        \begin{ND}
          \ndl{}{\(\phi\)}{假设}\label{1}
        ...
        \end{ND}
      \end{proof}
      \(\phi \land \psi \proves \phi\)\hfill（合取消去）
      \begin{proof}
        \leavevmode
        \begin{ND}[][ded:disjElim]
          \ndl{}{\(\phi \land \psi\)}{假设}\label{1}
          \ndl{}{\(\neg(\phi \to \neg\psi)\)}{\ref{1}，定义2.2.4}\label{2}
          % \ndl{}{\(\neg\psi \to (\phi \to \neg\psi)\)}{\(\rm P_1\)}\label{3}
          % \ndl{}{\((\neg\psi \to (\phi \to \neg\psi))
          %   \to (\neg\psi \to \neg(\phi \to \neg\psi))
          %   \to \psi\)}{\(\rm P_3\)}\label{4}
          % \ndl{}{\(\neg\psi \to \neg(\phi \to \neg\psi)\)}{\ref{2}，示例2.4.18}\label{5}
          % \ndl{}{\((\neg\psi \to \neg(\phi \to \neg\psi))
          %   \to \psi\)}{\ref{3}，\ref{4}，MP}\label{6}
          % \ndl{}{\(\psi\)}{\ref{5}，\ref{6}，MP}\label{7}
          \ndl{}{\(\neg\phi \to (\phi \to \neg\psi)\)}{\hyperref[lem:exFalso]{爆炸原理}，\hyperref[ded:comm]{交换演绎}}\label{8}
          \ndl{}{\((\neg\phi \to (\phi \to \neg\psi))
            \to (\neg\phi \to \neg(\phi \to \neg\psi))
            \to \phi\)}{\(\rm P_3\)}\label{9}
          \ndl{}{\(\neg\phi \to \neg(\phi \to \neg\psi)\)}{\ref{2}，示例2.4.18}\label{10}
          \ndl{}{\((\neg\phi \to \neg(\phi \to \neg\psi)) \to \phi\)}{\ref{8}，\ref{9}，MP}\label{11}
          \ndl{}{\(\phi\)}{\ref{10}，\ref{11}，MP}\label{12}
        \end{ND}
      \end{proof}
