...
\item[定理 2.4.21]
  ...
  \begin{lemma*}
    ...
    \begin{proof}
      \leavevmode
      \begin{ND}
        \ndl{}{\((\phi \to \psi) \to \neg\neg\phi \to (\phi \to \psi)\)}{\(\rm P_1\)}\label{1}
        \ndl{}{\((\neg\neg\phi \to \phi \to \psi) \to (\neg\neg\phi \to \phi) \to (\neg\neg\phi \to \psi)\)}{\(\rm P_2\)}\label{2}
        \ndl{}{\((\phi \to \psi) \to (\neg\neg\phi \to \phi) \to (\neg\neg\phi \to \psi)\)}{\ref{1}，\ref{2}，示例2.4.19}\label{3}
        \ndl{}{\(\neg\neg\phi \to \phi\)}{\hyperref[lem:dnElim]{双重否定消去引理}}\label{4}
        \ndl{}{\((\neg\neg\phi \to \phi) \to (\phi \to \psi) \to (\neg\neg\phi \to \psi)\)}{\ref{3}，\hyperref[ded:comm]{交换演绎}}\label{5}
        \ndl{}{\((\phi \to \psi) \to (\neg\neg\phi \to \psi)\)}{\ref{4}，\ref{5}，MP}
      \end{ND}
    \end{proof}
  \end{lemma*}
  \begin{lemma*}
    ...
    \begin{proof}
      ...
      \begin{ND}
        ...
        \ndl{}{\((\phi \to \psi) \to (\neg\neg\phi \to \psi)\)}{\hyperref[lem:dnIntroAnte]{双重否定前件引理}}\label{2}
  ...
  \begin{lemma*}
    ...
    \begin{proof}
      \leavevmode
      \begin{ND}
        \ndl{}{\((\phi \to \neg\psi) \to (\neg\neg\phi \to \neg\psi)\)}{\hyperref[lem:dnIntroAnte]{双重否定前件引理}}\label{1}
        \ndl{}{\((\neg\neg\phi \to \neg\psi) \to (\neg\neg\phi \to \psi) \to \neg\phi\)}{\(\rm P_3\)，\hyperref[ded:comm]{交换演绎}}\label{2}
        \ndl{}{\((\phi \to \neg\psi) \to (\neg\neg\phi \to \psi) \to \neg\phi\)}{\ref{1}，\ref{2}，示例2.4.19}\label{3}
        \ndl{}{\((\phi \to \psi) \to (\neg\neg\phi \to \psi)\)}{\hyperref[lem:dnIntroAnte]{双重否定前件引理}}\label{4}
        \ndl{}{\((\neg\neg\phi \to \psi) \to (\phi \to \neg\psi) \to \neg\phi\)}{\ref{3}，示例2.4.19}\label{5}
    ...
    \item \(\Set{\phi, \psi} \proves \phi \land \psi\)\hfill（\hypertarget{ded:conjIntro}{合取引入}）
      \begin{proof}
        ...
        \begin{ND}[][][][\rwidth{ded:raa}]
          ...
          \ndl{}{\(((\phi \to \neg\psi) \to \psi)
            \to ((\phi \to \neg\psi) \to \neg\psi)
            \to \neg(\phi \to \neg\psi)\)}{\hyperref[lem:p3var]{\(\rm P_3\)变形}}\label{4}
    ...
    \item \(\Set{\neg\phi \to \psi, \neg\phi \to \neg\psi} \proves \phi\)\hfill（反证法）
      ...
      \begin{proof}
        ...
        \begin{ND}[][][][\rwidth{ded:raa}]
          \ndl{}{\(\phi \to \psi\)}{假设}\label{1}
          \ndl{}{\(\phi \to \neg\psi\)}{假设}\label{2}
          \ndl{}{\((\phi \to \psi) \to (\phi \to \neg\psi) \to \neg\phi\)}{\hyperref[lem:p3var]{\(\rm P_3\)变形}}\label{3}
