...
\item[定理 2.4.21] 下面，我们先证明一些引定理和引演绎。我们把它们统称为引理，可以看到这些引理的使用能让后续证明的结构清晰明了。
  ...
  \item \(\Set{\phi, \psi} \proves \phi \land \psi\)\hfill（\hypertarget{ded:conjIntro}{合取引入}）
    ...
    \begin{proof}
      ...
      % \end{ND}
    \end{proof}
  \item \(\phi \proves \phi \lor \psi\)\hfill（\hypertarget{ded:disjIntro}{析取引入}）
    \begin{proof}
      \leavevmode
      \begin{ND}[][][][\rwidth{ded:conjAssoc2}]
        \ndl{}{\(\phi\)}{假设}\label{1}
  ...
  \item \(\Set{\phi \to \psi, \psi \to \phi} \proves \phi \leftrightarrow \psi\)\hfill（等值引入）
    ...
    \begin{proof}
      ...
      \end{ND}
    \end{proof}
  \item \(\Set{\neg\phi \to \psi, \neg\phi \to \neg\psi} \proves \phi\)\hfill（\hypertarget{ded:contradict}{反证法}）
    \begin{proof}
      \leavevmode
      \begin{ND}[][][][\rwidth{ded:conjAssoc2}]
      ...
      \end{ND}
    \end{proof}
    \(\Set{\phi \to \psi, \phi \to \neg\psi} \proves \neg\phi\)\hfill（\hypertarget{ded:raa}{归谬法}）
    \begin{proof}
      \leavevmode
      \begin{ND}[][][][\rwidth{ded:conjAssoc2}]
        \ndl{}{\(\phi \to \psi\)}{假设}\label{1}
  ...
  \item \(\phi \land \psi \vdashv \psi \land \phi\)\hfill（\hypertarget{ded:conjComm}{交换律1}）
    ...
    \begin{proof}
      ...
      \end{ND}
    \end{proof}
  \item \(\neg(\phi \land \psi) \vdashv \neg\phi \lor \neg\psi\)\hfill（\hypertarget{ded:dm1}{德·摩根律1}）
    \begin{proof}
      ...
      \end{ND}
    \end{proof}
    \(\neg(\phi \lor \psi) \vdashv \neg\phi \land \neg\psi\)\hfill（\hypertarget{ded:dm2}{德·摩根律2}）
    \begin{proof}
  ...
  \item \(\phi \leftrightarrow \psi \vdashv \neg\phi \leftrightarrow \neg\psi\)\hfill（等值否定交换1）
    \begin{proof}
      ...
      \end{ND}
      再证\(\neg\phi \leftrightarrow \neg\psi \proves \phi \leftrightarrow \psi\)。可以仿照上面的演绎，步骤完全一样，就是在使用\hyperlink{ded:contrapose1}{假言易位1}的时候，使用的方向不一样。下面是另外一种思路。
      \begin{ND}[][][][\rwidth{ded:conjAssoc2}]
        \ndl{}{\(\neg\phi \leftrightarrow \neg\psi\)}{假设}\label{1}
    ...
    \begin{proof}
      先证\(\neg\phi \leftrightarrow \psi \proves \phi \leftrightarrow \neg\psi\)。只需将前一个证明第1部分第\ndref{ded:equiv}{6}、\ndref{ded:equiv}{7}步中的\hyperlink{ded:contrapose1}{假言易位1}依次改成\hyperlink{ded:contrapose3}{假言易位3}和\hyperlink{ded:contrapose2}{2}即可。

      再证\(\phi \leftrightarrow \neg\psi \proves \neg\phi \leftrightarrow \psi\)。只需将前一个证明第1部分第\ndref{ded:equiv}{6}、\ndref{ded:equiv}{7}步中的\hyperlink{ded:contrapose1}{假言易位1}依次改成\hyperlink{ded:contrapose2}{假言易位2}和\hyperlink{ded:contrapose3}{3}即可。
    \end{proof}
...
\item[习题 2.4.33] \(\neg(\phi \lor \psi \lor \theta) \proves \neg(\phi \land \psi)\)。
  \begin{proof}
    \leavevmode
    \begin{ND}
      \ndl{}{\(\neg((\phi \lor \psi) \lor \theta)\)}{假设}\label{1}
      \ndl{}{\(\neg(\phi \lor \psi) \land \neg\theta\)}{\ref{1}，\hyperlink{ded:dm2}{德·摩根律2}}\label{2}
      \ndl{}{\(\neg(\phi \lor \psi)\)}{\ref{2}，\hyperlink{ded:conjElim}{合取消去}}\label{3}
      \ndl{}{\(\neg\phi \land \neg\psi\)}{\ref{3}，\hyperlink{ded:dm2}{德·摩根律2}}\label{4}
      \ndl{}{\(\neg\phi\)}{\ref{4}，\hyperlink{ded:conjElim}{合取消去}}\label{5}
      \ndl{}{\(\neg\phi \lor \neg\psi\)}{\ref{5}，\hyperlink{ded:disjIntro}{析取引入}}\label{6}
      \ndl{}{\(\neg(\phi \land \psi)\)}{\ref{6}，\hyperlink{ded:dm1}{德·摩根律1}}
    \end{ND}
  \end{proof}
...
\item[习题 2.4.35] \(\phi \land \psi \to \theta \proves \phi \land \neg\theta \to \neg\psi\)。
  \begin{proof}
    ...
    \begin{ND}
      \ndl{}{\(\phi \land \psi \to \theta\)}{假设}\label{1}
      \ndl{}{\(\phi \to (\psi \to \theta)\)}{\ref{1}，\hyperlink{ded:exp}{输出律}}\label{2}
      \ndl{}{\((\psi \to \theta) \to (\neg\theta \to \neg\psi)\)}{\hyperlink{ded:contrapose1}{假言易位1}，演绎定理}\label{3}
      \ndl{}{\(\phi \to (\neg\theta \to \neg\psi)\)}{\ref{2}，\ref{3}，示例2.4.19}\label{4}
      \ndl{}{\(\phi \land \neg\theta \to \neg\psi\)}{\ref{4}，\hyperlink{ded:exp}{输出律}}
    \end{ND}
  \end{proof}
\item[习题 2.4.36]
  \begin{itemize}
